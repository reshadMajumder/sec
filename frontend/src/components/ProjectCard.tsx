        ...
        {isCenter && (
          ...
          >
            <div className="absolute bottom-8 w-full px-8 text-white text-center">
              <span className="text-[10px] font-mono mb-2 tracking-widest block opacity-60">
                PROJECT {project.number}
              </span>
              <h3 className="text-xl md:text-3xl font-black tracking-tighter leading-none uppercase leading-none">
                {project.name}
              </h3>
            </div>
          </motion.div>
