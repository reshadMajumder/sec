...
export function WingDetail() {
    ...
    return (
      <div className="fixed inset-0 z-[1000] bg-brand-off-white flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-8 py-3 bg-black text-white font-bold uppercase tracking-widest"
          >
            Go Home
          </button>
        </div>
  ...
  const x = useTransform(smoothProgress, [0, 1], ["0%", "-66.70%"]);
            ...
            <section className="w-[100vw] h-full flex flex-col lg:flex-row flex-shrink-0">
              <div className="w-full lg:w-1/2 h-1/2 lg:h-full relative overflow-hidden bg-neutral-200">
                ...
                <div className="absolute bottom-12 left-12 flex flex-col gap-1">
                  ...
                  <span className="text-white text-[10px] font-mono tracking-widest uppercase opacity-60">
                    SYSTEM_ENTITY_0{wing.id.length}
                  </span>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col justify-center p-8 md:p-24 space-y-12 bg-brand-off-white">
                ...
                >
                  <span className="text-[10px] font-mono tracking-[0.5em] text-black/30 uppercase mb-4 block">
                    IDENTITY_PROTOCOL
                  </span>
                ...
                <div className="flex gap-4 items-center">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-bold tracking-widest uppercase underline underline-offset-4">
                      01_IDENT_ENTRY
                    </span>
                  </div>
                ...
                <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-24 relative z-10">
                  <div className="space-y-16">
                    <div className="space-y-4">
                      <span className="text-[10px] font-mono tracking-[0.4em] text-brand-black/40 uppercase block">
                        OPERATIONAL_START
                      </span>
                      <p className="text-4xl md:text-6xl font-black uppercase tracking-tighter tabular-nums">
                        {wing.details?.establishmentDate || "2024"}
                      </p>
                    </div>
                    <div className="space-y-4">
                      <span className="text-[10px] font-mono tracking-[0.4em] text-brand-black/40 uppercase block">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-8">
                        {wing.details?.achievements?.map((item, i) => (
                          <div
                            key={i}
                            className="flex gap-4 border-l-2 border-black/5 pl-6 py-1"
                          >
                  ...
                  <div className="space-y-16">
                    <div className="flex items-start gap-8">
                      <div className="space-y-2">
                        ...
                        <p className="text-8xl lg:text-9xl font-black uppercase tracking-tighter tabular-nums leading-none">
                          {wing.details?.membersCount || "0"}
                        </p>
                        <span className="text-[10px] font-bold tracking-[0.2em] uppercase opacity-30">
                          CERTIFIED_MEMBERS_CORE
                        </span>
                      </div>
                      ...
                      <div className="hidden lg:flex flex-col justify-between h-[200px] py-4">
                        ...
                        <p
                          className="text-[8px] font-black uppercase tracking-widest opacity-20 py-4 rotate-180"
                    ...
                    <div className="p-8 border border-black/5 bg-black/[0.02]">
                      <span className="text-[10px] font-mono tracking-[0.4em] text-brand-black/40 uppercase block mb-4">
                        ENTITY_SUMMARY
                      </span>
                      <p className="text-xs font-bold leading-relaxed opacity-50 uppercase">
                        This structural unit focuses on scalability and
                        decentralized collaboration within the DIU SEC
                        ecosystem. Every milestone is a testament to the core
                        values of engineering excellence.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 flex items-center justify-center p-12 md:p-24 lg:p-32 bg-brand-black">
                <div className="space-y-12">
                  <h2 className="text-6xl md:text-[8rem] lg:text-[10rem] font-black tracking-tighter uppercase leading-[0.75]">
                    THE
                    <br />
                    <span className="text-white/10 outline-text">VISION.</span>
                  </h2>
                  ...
                  <p className="max-w-lg text-lg md:text-2xl font-medium opacity-60 uppercase italic leading-relaxed">
                    WE DON’T JUST LEARN; WE BUILD. THE {wing.name.toUpperCase()}{" "}
                    UNIT IS COMMITTED TO EXCELLENCE IN EVERY SECTOR OF CAMPUS
                    LIFE, ENSURING THE NEXT GEN OF ENGINEERS ARE READY.
                  </p>

                  {wing.details?.keyProjects && (
                    <div className="pt-8 space-y-6">
                      <span className="text-[10px] font-mono tracking-[0.4em] text-white/40 uppercase block">
                        CORE_SYSTEM_PROJECTS
                      </span>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {wing.details.keyProjects.map((project, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-4 bg-white/5 p-4 border border-white/5 hover:border-white/20 transition-all group"
                          >
                            <span className="text-[10px] font-bold opacity-30">
                              0{i + 1}
                            </span>
                            <span className="text-sm font-black uppercase tracking-tight group-hover:tracking-widest transition-all">
                              {project}
                            </span>
                          </div>
                        ))}
              ...
              <div className="flex-1 grid grid-cols-1 border-l border-white/5">
                <div className="bg-neutral-900 overflow-hidden relative h-[40vh] md:h-[50vh]">
                  ...
                  <div className="absolute bottom-12 left-12">
                    <span className="text-[60px] font-black opacity-10 italic leading-none">
                      V-{wing.id.length}
                    </span>
                ...
                <div className="bg-neutral-800 flex flex-col justify-center p-12 space-y-12 h-[60vh] md:h-[50vh]">
                  <div className="space-y-6">
                    <span className="text-[10px] font-mono tracking-[0.4em] text-white/40 uppercase block">
                      COMMITMENT_ARCHITECTURE
                    </span>
                    <p className="text-sm font-bold leading-relaxed opacity-60 uppercase max-w-md">
                      Every project undertaken by the {wing.name} is
                      peer-reviewed and maintained under the strict protocols of
                      the DIU Software Engineering Club. Integrity, Clean Code,
                      and Scalability are our non-negotiables.
                    </p>
                  </div>
                  <div className="h-px w-full bg-white/10" />
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black uppercase tracking-widest opacity-40">
                      © 2026 DIU SEC // ALL RIGHTS RESERVED
                    </span>
