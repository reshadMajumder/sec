...
export function WingsSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-brand-off-white text-brand-black py-24 md:py-48 px-6 md:px-12 lg:px-24 overflow-hidden z-20"
    >
          ...
          <div className="lg:col-span-4 sticky top-12 md:top-24 lg:top-32 h-fit z-30 pt-4 bg-brand-off-white/80 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none">
            ...
            >
              <div className="space-y-4 md:space-y-6">
                <span className="text-[10px] font-mono tracking-[0.4em] opacity-40 uppercase block">
                ...
                <div className="space-y-4 max-w-sm">
                  ...
                  <p className="hidden md:block text-sm opacity-60 font-medium leading-relaxed">
                    Each wing delivers specialized learning pathways, projects,
                    and publications for student members.
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="absolute inset-0 z-0">
                    <img
                      src={wing.imageUrl}
                      alt={wing.name}
                      className="w-full h-full object-cover group-hover:opacity-100 scale-105 group-hover:scale-100 transition-all duration-800 ease-out"
                    />
                  ...
                  <div className="relative z-10 p-8 md:p-12 flex flex-col h-full group-hover:text-white transition-colors duration-500">
                    <div className="mb-6 md:mb-8 flex justify-between items-start">
                      ...
                      <ArrowUpRight
                        className="opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 duration-500"
                        size={20}
                      />
                    </div>
                    ...
                    <div className="mt-auto flex items-center gap-2 overflow-hidden">
                      <span className="text-[10px] font-black tracking-widest uppercase opacity-40 group-hover:opacity-100 transition-all translate-y-8 group-hover:translate-y-0 duration-500">
                        Explore Wing
                      </span>
