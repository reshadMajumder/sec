    ...
    <section className="relative bg-brand-black text-brand-off-white py-24 md:py-48 px-6 md:px-12 lg:px-24 overflow-hidden z-20">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="mb-24 md:mb-40">
          ...
          >
            <span className="text-[10px] font-mono tracking-[0.4em] opacity-40 uppercase block mb-6">
              GOVERNANCE / 2025
            </span>
            ...
            <div className="mt-12 flex flex-col md:flex-row gap-8 items-start md:items-center">
              <p className="text-sm md:text-xl opacity-60 max-w-xl font-medium">
                The dedicated members driving every initiative, event, and
                publication of the Software Engineering Club forward.
              </p>
          ...
          {COMMITTEE.map((group, groupIndex) => (
            <div key={group.id} className="relative">
              ...
              <div className="mb-12 flex items-baseline gap-4">
                <span className="text-sm font-mono opacity-20">
                  0{groupIndex + 1}
                </span>
                      ...
                      <div className="absolute inset-0 z-0 flex items-center justify-center overflow-hidden">
                        {member.imageUrl ? (
                          <motion.img
                            src={member.imageUrl}
                            alt={member.name}
                            className="w-full h-full object-cover  group-hover:opacity-100 group-hover:scale-110 transition-all duration-700"
                          />
                        ) : (
