...
export const EventsSection: React.FC = () => {
  ...
  return (
    <section
      id="events"
      className="py-32 bg-brand-black text-white overflow-hidden scroll-mt-20"
    >
        ...
        <div className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            >
              ACTIVE
              <br />
              <span className="text-white/10 outline-text">EVENTS.</span>
            </motion.h2>
          </div>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            JOIN THE FRONTLINE OF INNOVATION. SECURE YOUR SPOT IN OUR UPCOMING
            TECHNICAL SESSIONS AND HACKATHONS.
          </motion.p>
        </div>
