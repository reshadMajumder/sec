    ...
    <section className="relative bg-brand-off-white text-brand-black py-24 md:py-48 px-6 md:px-12 lg:px-24 overflow-hidden z-20">
      <div className="max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24">
          {/* Header */}
          <div className="lg:col-span-4 space-y-8 sticky top-1/2 -translate-y-1/2 h-fit">
            <motion.div
            ...
            >
              <span className="text-[10px] font-mono tracking-[0.4em] opacity-40 uppercase block mb-4">
                TIMELINE / 2025-26
              </span>
              ...
              <p className="mt-8 text-sm md:text-base opacity-60 max-w-xs font-medium">
                What the club delivered this semester. A record of collective
                effort and shared moments.
              </p>
            </motion.div>
          </div>
